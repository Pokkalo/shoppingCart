...
<svg class="--home-dashline1" viewBox="0 0 300 300">
  ...
  <path class="cls-1" d="m223.93,355.12c-.34,0-.68-.13-.93-.39-.5-.51-.49-1.33.03-1.83,1.82-1.77,3.63-3.62,5.38-5.51.48-.52,1.3-.56,1.83-.07.53.49.56,1.3.07,1.83-1.78,1.93-3.62,3.81-5.48,5.61-.25.24-.58.37-.9.37Z" fill='#e7b387'/>
        ...
        <div className="--rank_card col">
         ...
         <path class="cls-1" d="m173.53,189.6c0,1.93-.86,3.7-2.58,5.32-1.72,1.62-3.6,2.43-5.62,2.43-4.86,0-12.16.05-21.89.15-9.73.1-17.03.15-21.89.15-3.75,0-5.57-1.62-5.47-4.86l.15-1.67c1.42-38.72,2.13-62.18,2.13-70.39v-45.15c0-2.84-.66-4.26-1.98-4.26-2.03,0-5.09.61-9.2,1.82s-7.22,1.82-9.35,1.82c-3.14,0-4.71-1.88-4.71-5.62,0-3.45-.05-8.61-.15-15.51-.1-6.89-.15-12.11-.15-15.66,0-2.03,1.27-3.55,3.8-4.56,14.9-6.18,26.6-14.49,35.12-24.93,1.72-2.13,3.19-3.19,4.41-3.19.2,0,.81.1,1.82.3,3.85.81,9.58,2.08,17.18,3.8,4.05.51,9.98,1.42,17.79,2.74,1.42.41,2.13,1.52,2.13,3.34,0,.61-.1,1.67-.3,3.19-1.11,8.92-1.67,30.76-1.67,65.52,0,11.66.08,29.19.23,52.6.15,23.41.23,40.95.23,52.6Z" transform="translate(50, 35)" fill="#236e82" stroke="#f2e4c2" stroke-miterlimit="10" stroke-width="11px"/>
         <path class="cls-2" d="m39.25,61.2s-22.96-36.74-35.08.15c-12.12,36.89,45.13,40.47,69.5,46.58,0,0,12.61-56.58-2.25-81.54-5.57-9.35-33.71-15.25-32.17,34.81Z" transform="translate(50, 35)" fill="#f79cb8" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="5px"/>
         <path  d="m555.32,279c0,153.42-124.37,277.78-277.78,277.78-368.48-14.63-368.37-540.99,0-555.57,153.41,0,277.78,124.37,277.78,277.79h0Z" fill="none" stroke="#e7b387" stroke-width="4.5px" stroke-miterlimit="10" stroke-dasharray="0 0 38.45 26.45" transform="translate(220, 85)"/>
    </svg></div>
